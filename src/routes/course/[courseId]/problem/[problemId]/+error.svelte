			...
			<MagicCard gradientColor="#D9D9D955" class="p-0">
				<CardHeader class="p-8 text-center">
					...
					<CardDescription class="mt-2 text-lg">
						You are not enrolled in this course or cannot view this problem.
					</CardDescription>
				</CardHeader>
		...
		>
			<MagicCard gradientColor="#D9D9D955" class="p-0">
				<CardHeader class="p-8 text-center">
					...
					<CardTitle class="text-2xl font-semibold">Problem not found</CardTitle>
					<CardDescription class="mt-2 text-lg">
						We could not find problem {problemId} in this course.
					</CardDescription>
				</CardHeader>
				<CardContent class="px-8 pb-8">
					<div class="space-y-4 text-center">
